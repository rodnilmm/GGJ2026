...
public class palmTreeScript : MonoBehaviour
{
    ...
    //Create the first tile of the palm tree group
    public void CreatePalmTree()
    {
        ...
        if (biomeScript.isGrassBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.GRASS)
            {
                ...
                {
                    biomeSelector.tileScript.tileType = tileScript.TileType.PALM_TREE;
        ...
        else if (biomeScript.isSandBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.SAND)
            {
                if (randomNumToIterate <= 50)
                {
                    ...
                    randomNumToIterate = Random.Range(1, 101);
                    if (randomNumToIterate <= valuesAdjusterScript.sandBiomesPalmTreeExpansionPercentage)
                    {
                        ExtendPalmTree();
                    }
                }
    ...
    //Create the rest tiles of the palm tree group
    private void ExtendPalmTree()
    {
        int randomNumToIterate;
        randomNumToIterate = Random.Range(1, 101);
            ...
            if (randomNumToIterate <= 0)
            {
                ...
                if (canCheckTerrainTile)
                {
                    if (randomNumToChooseDirection == 0)
                    {
                        ...
                        {
                            biomeSelector.tileScript.topAdjacentTile.tileType = tileScript.TileType.PALM_TREE;
                    ...
                    if (randomNumToChooseDirection == 1)
                    {
                        ...
                        {
                            biomeSelector.tileScript.rightAdjacentTile.tileType = tileScript.TileType.PALM_TREE;
                    ...
                    if (randomNumToChooseDirection == 2)
                    {
                        ...
                        {
                            biomeSelector.tileScript.bottomAdjacentTile.tileType = tileScript.TileType.PALM_TREE;
                    ...
                    if (randomNumToChooseDirection == 3)
                    {
                        ...
                        {
                            biomeSelector.tileScript.leftAdjacentTile.tileType = tileScript.TileType.PALM_TREE;

...
public class flowersScript : MonoBehaviour
{
    ...
    //Create the first tile of the flowers group
    public void CreateFlowers()
    {
        ...
        if (biomeScript.isGrassBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.GRASS)
            {
                ...
                {
                    biomeSelector.tileScript.tileType = tileScript.TileType.FLOWERS;

                    randomNumToIterate = Random.Range(1, 101);
                    if (randomNumToIterate <= valuesAdjusterScript.grassBiomesFlowersExpansionPercentage)
                    {
                        ExtendFlowers();
                    }
                }
    ...
    //Create the rest tiles of the flowers group
    private void ExtendFlowers()
    {
        int randomNumToIterate;
        randomNumToIterate = Random.Range(1, 101);
            ...
            if (randomNumToIterate <= valuesAdjusterScript.grassBiomesFlowersExpansionPercentage)
            {
                ...
                if (canCheckTerrainTile)
                {
                    if (randomNumToChooseDirection == 0)
                    {
                        ...
                        {
                            biomeSelector.tileScript.topAdjacentTile.tileType = tileScript.TileType.FLOWERS;
                    ...
                    if (randomNumToChooseDirection == 1)
                    {
                        ...
                        {
                            biomeSelector.tileScript.rightAdjacentTile.tileType = tileScript.TileType.FLOWERS;
                    ...
                    if (randomNumToChooseDirection == 2)
                    {
                        ...
                        {
                            biomeSelector.tileScript.bottomAdjacentTile.tileType = tileScript.TileType.FLOWERS;
                    ...
                    if (randomNumToChooseDirection == 3)
                    {
                        ...
                        {
                            biomeSelector.tileScript.leftAdjacentTile.tileType = tileScript.TileType.FLOWERS;

...
public class cactusScript : MonoBehaviour
{
    ...
    //Create the first tile of the cactus group
    public void CreateCactus()
    {
        ...
        if (biomeScript.isGrassBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.GRASS)
            {
                ...
                {
                    biomeSelector.tileScript.tileType = tileScript.TileType.CACTUS;
        ...
        else if (biomeScript.isSandBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.SAND)
            {
                if (randomNumToIterate <= 50)
                {
                    ...
                    randomNumToIterate = Random.Range(1, 101);
                    if (randomNumToIterate  <= valuesAdjusterScript.sandBiomesCactusExpansionPercentage)
                    {
                        ExtendCactus();
                    }
                }
            ...
            if (randomNumToIterate <= 0)
            {
                ...
                if (canCheckTerrainTile)
                {
                    if (randomNumToChooseDirection == 0)
                    {
                        ...
                        {
                            biomeSelector.tileScript.topAdjacentTile.tileType = tileScript.TileType.CACTUS;
                    ...
                    if (randomNumToChooseDirection == 1)
                    {
                        ...
                        {
                            biomeSelector.tileScript.rightAdjacentTile.tileType = tileScript.TileType.CACTUS;
                    ...
                    if (randomNumToChooseDirection == 2)
                    {
                        ...
                        {
                            biomeSelector.tileScript.bottomAdjacentTile.tileType = tileScript.TileType.CACTUS;
                    ...
                    if (randomNumToChooseDirection == 3)
                    {
                        ...
                        {
                            biomeSelector.tileScript.leftAdjacentTile.tileType = tileScript.TileType.CACTUS;

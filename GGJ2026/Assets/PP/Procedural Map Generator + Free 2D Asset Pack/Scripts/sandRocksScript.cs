...
public class sandRocksScript : MonoBehaviour
{
    ...
    //Create first tile of the sand rocks group
    public void CreateSandRocks()
    {
        ...
        if (biomeScript.isGrassBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.GRASS)
            {
                ...
                {
                    biomeSelector.tileScript.tileType = tileScript.TileType.SAND_ROCKS;
        ...
        else if (biomeScript.isSandBiome)
        {
            if (stage == 0 && biomeSelector.tileScript.tileType == tileScript.TileType.SAND)
            {
                if (randomNumToIterate <= 50)
                {
                    ...
                    randomNumToIterate = Random.Range(1, 101);
                    if (randomNumToIterate <= valuesAdjusterScript.sandBiomesSandRocksExpansionPercentage)
                    {
                        ExtendSandRocks();
                    }
                }
    ...
    //Create the rest tiles of the sand rocks group
    private void ExtendSandRocks()
    {
        int randomNumToIterate;
        randomNumToIterate = Random.Range(1, 101);
            ...
            if (randomNumToIterate <= 0)
            {
                ...
                if (canCheckTerrainTile)
                {
                    if (randomNumToChooseDirection == 0)
                    {
                        ...
                        {
                            biomeSelector.tileScript.topAdjacentTile.tileType = tileScript.TileType.SAND_ROCKS;
                    ...
                    if (randomNumToChooseDirection == 1)
                    {
                        ...
                        {
                            biomeSelector.tileScript.rightAdjacentTile.tileType = tileScript.TileType.SAND_ROCKS;
                    ...
                    if (randomNumToChooseDirection == 2)
                    {
                        ...
                        {
                            biomeSelector.tileScript.bottomAdjacentTile.tileType = tileScript.TileType.SAND_ROCKS;
                    ...
                    if (randomNumToChooseDirection == 3)
                    {
                        ...
                        {
                            biomeSelector.tileScript.leftAdjacentTile.tileType = tileScript.TileType.SAND_ROCKS;
